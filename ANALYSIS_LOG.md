...
**F1 · Pre-transaction validation guard (funds, amount, self-transfer)**
...
**F2 · One authoritative balance calculation**
...
**F3 · Transfer settlement — debit and credit applied at commit**
...
**F4 · Delimiter-safe record encoding**
...
**F5 · Load-time schema validation and quarantine of bad rows**
...
**F6 · Shared record validation applied to create *and* edit**
...
**F7 · Account status and non-destructive closure**
...
**F9 · An explicit role attribute, replacing username-string authorisation**
...
**F10 · Credential and PII masking in the UI**
...
**F11 · Session lifecycle — establish on login, clear on logout**
...
**F12 · Append-only audit trail for money and privileged operations**
...
**F13 · System-generated transaction timestamps**
...
**F14 · Atomic, recoverable file writes with backup**
...
**F15 · Transaction receipt and account statement**
